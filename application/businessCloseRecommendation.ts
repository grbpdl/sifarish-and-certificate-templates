const businessCloseTemplate = `<!DOCTYPE html>
<html lang="en">
   <head>
      <meta charset="UTF-8" />
      ...
      <section id="template">
         <section class="application_section">
            ...
            <div class="main_section">
               <div class="subject">बिषय : व्यबसाय बन्द बारे ।</div>
               ##MUNICIPALITY_NAME## महा/उपमहा/नगरपालिका/गाउँपालिका वडा नं ##WARD## को
               ##DISTRICT_NAME## ,##MUNICIPALITY_NAME##
               (साबिकको   ठेगाना ) मा रहेका श्री / सुश्री / श्रीमती ##FIRST_NAME## ##MIDDLE_NAME## ##LAST_NAME##
               को नाममा रहेको निम्न उल्लेखित व्यवसाय मिति ##OCCUPATION_CLOSE_DATE## देखि बन्द भएको भनी निजले पेश गरेको निवेदन उपर स्थल सर्जमिन बुझ्दा
...
export default businessCloseTemplate;
