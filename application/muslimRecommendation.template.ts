...
export const muslimRecommendationTemplate = `<!DOCTYPE html>
<html lang="ne">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>मुस्लिम प्रमाणित</title>
    <style>
      ${style}
      ${globalTemplateStyle}
      .greet {
  ...
  <body>
    <div class="a4-page">
      ...
      <div class="subject">
        <p>विषयः- <span>मुस्लिम प्रमाणित सम्बन्धमा ।</span></p>
      </div>
      <div class="paragraph">
        <p>
          उपरोक्त सम्बन्धमा ##DISTRICT## जिल्ला
          ##LOCAL_LEVEL## वडा नं. ##WARD_NUMBER## बस्ने श्री
          ...
          ##REPLACEABLE_HIS_HER## ##FIRST_NAME## ##MIDDLE_NAME## ##LAST_NAME##ले म नेपालको सूचीकृत मुस्लिम भित्र पर्ने
