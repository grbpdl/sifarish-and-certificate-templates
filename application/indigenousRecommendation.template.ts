...
export const indigenousRecommendationTemplate = `<!DOCTYPE html>
<html lang="ne">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="a4-page">
      ...
      <div class="subject">
        <p>विषयः- <span>आदिवासी प्रमाणित सम्बन्धमा ।</span></p>
      </div>
      <div class="paragraph">
        <p>
          ...
          ##REPLACEABLE_HIS_HER## ##FIRST_NAME## ##MIDDLE_NAME## ##LAST_NAME## ले म नेपालको सूचीकृत आदिवासी भित्र पर्ने
