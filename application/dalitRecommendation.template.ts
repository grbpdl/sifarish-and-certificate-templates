...
export const dalitRecommendationTemplate = `<!DOCTYPE html>
<html lang="ne">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>दलित प्रमाणित सम्बन्धमा</title>
    <style>
      ${style}
      ${globalTemplateStyle}
      .greet {
  ...
  <body>
    <div class="a4-page">
      ...
      <div class="subject">
        <p>विषयः- <span>दलित प्रमाणित सम्बन्धमा ।</span></p>
      </div>
      <div class="paragraph">
        <p>
          ...
          श्री ##FIRST_NAME## ##MIDDLE_NAME## ##LAST_NAME## ले 
          म नेपालको सूचीकृत दलित भित्र पर्ने
