const physciallyDisabledCerificateTemplate = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
 ...
 width: 210mm;
  ...
  <div style="text-align:end;">
    <div>##C_DATE## </div>
      ...
      <div class="to">
        श्री महिला तथा बाल विकास कार्यालय
        <br />
      ...
      <div class='letter'>
      उपरोक्त सम्बन्धमा ##DISTRICT_NAME## जिल्ला ,##PROVINCE_NAME##
      वडा न.##WARD##, ##MUNICIPALITY_NAME##,
      बस्ने श्री ##FIRST_NAME##
      ##MIDDLE_NAME## ##LAST_NAME## (अपाङ्गताको किसिम उल्लेख गर्ने)
      ##TYPE_OF_PHYSICALLY_DISABILITY## अपाङ्ग भएकोले अपाङ्ग परिचय पत्र बनाउनको
      लागि "सिफारिस गरी पाउँ भनी यस वडा कार्यालयमा पर्न आएको निवेदन सम्बन्धमा
      तहाँको नियमानुसार अपाङ्ग परिचयपत्रको लागि सिफासि गरिन्छ ।
      </div>
          <br />
          <br /> 
        <div class="from">
...
export default physciallyDisabledCerificateTemplate;
