const tapConnectionApplicationTemplate = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <div style="text-align:end;">
    <div>##C_DATE## </div>
      ...
      <div class="main_section">  
        ...
        <div class="subject">बिषय : धारा जडान सिफारिस ।</div>   
        <div class="to">
          श्री __________
          <br />
          _____________ ।
        ...
        <div class="letter">   
           ##DISTRICT_NAME## जिल्ला,  ##MUNICIPALITY_NAME##  वडा नं. ##WARD## (साबिकको ठेगना ##OLD_ADDRESS##)
            बस्ने श्री ##FIRST_NAME## ##MIDDLE_NAME## ##LAST_NAME##
            को नाममा दर्ता कायम रहेको कि.नं ##KITTA_NUMBER## को जग्गामा मिति ##HOUSE_CONSTRUCTION_DATE##
            मा भवन निर्माण स्विकृति लिनु भई आंशिक / पूर्ण रुपमा निर्माण सम्पन्न गर्नुभएको वा अभिलेखीकरण गर्नुभएको हुँदा ##DRINKING_WATER_COMPANY_NAME## खानेपानि 
            लाईन जडान गरिदिन हुन सिफारिस साथ अनुरोध गरिन्छ |
        </div>
...
export default tapConnectionApplicationTemplate;
