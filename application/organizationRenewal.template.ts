const organizationRenewalTemplate = `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
​        उपरोक्त सम्बन्धमा यस ##DISTRICT_NAME## जिल्ला, ##MUNICIPALITY_NAME##, वडा नं.##WARD## स्थित रहेको ##ORGANIZATION_NAME##
        नामक संस्था नविकरण गर्न पर्ने भएकोले सो को लागि “सिफारिस गरी पाऊ” 
        भनी यस वडा कार्यालयमा पर्न आएको निवेदन सम्बन्धमा त्यस कार्यालयको नियमानुसार गरिदिनुहुन सिफारिस गरिन्छ ।
        <div class="letter">        
...
export default organizationRenewalTemplate;
