import {globalTemplateStyle} from "../../templates/templateStyles";
import { tableStyle } from "../../templates/applicationLetterStyles/letterGlobalStyle";
export const muslimRecommendationLetterTemplate = `
<!DOCTYPE html>
<html lang="ne">
  <head>
    <meta charset="UTF-8" />
    <title>मुस्लिम प्रमाणित निवेदन</title>
    <style>
      ${globalTemplateStyle}
      ${tableStyle}
    </style>
    ...
    <section class="application_section">
      ...
      <div class="main_section">
        ...
        <div class="subject" style="text-align:center;">
          <b>विषय: <u>मुस्लिम सिफारिस गरि पाउँ ।</u></b>
        </div>
